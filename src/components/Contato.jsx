    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-100 py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Conheça nossa equipe e envie sua mensagem. Estamos sempre prontos para ajudar!
          </p>
        </div>
      </div>
      ...
      <section className="bg-gradient-to-b from-gray-50 to-white py-24 px-4 mx-auto max-w-screen-xl">
        <div className="text-center mb-20">
          <h2 className="mb-6 text-4xl lg:text-5xl tracking-tight font-extrabold text-gray-900">
            Nosso Time
          </h2>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 md:p-12 mb-16">
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              {submitMessage && (
                <div className={`p-4 rounded-lg ${submitMessage.includes('sucesso') 
