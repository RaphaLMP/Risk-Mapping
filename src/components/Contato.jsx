...
const Contato = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Simulação de envio (substitua pela sua lógica de envio real)
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Seção do Time */}
      <section className="bg-gradient-to-b from-gray-50 to-white py-24 px-4 mx-auto max-w-screen-xl">
        <div className="text-center mb-20">
          <h2 className="mb-8 text-4xl lg:text-5xl tracking-tight font-extrabold text-gray-900">
            Nosso Time
          </h2>
        </div>
          ...
          {teamMembersData.map((member, index) => (
            <div key={`${member.name}-${index}`} className="text-center">
              <div className="relative mb-6">
                <img
                  className="mx-auto w-36 h-36 rounded-full object-cover ring-4 ring-white shadow-lg"
                  src={member.imageSrc}
      ...
      <section className="bg-white py-24 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 md:p-12 mb-16 relative overflow-hidden">
            {/* Animação de sucesso */}
            {showSuccessAnimation && (
              <div className="absolute inset-0 bg-green-50 bg-opacity-95 flex items-center justify-center z-10 rounded-2xl">
                <div className="text-center">
                  ...
                  <h3 className="text-2xl font-bold text-green-800 mb-2">Enviado com sucesso!</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-8" noValidate>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="nome" className="block text-sm font-medium text-gray-700 mb-3">
                  ...
                  />
                  {errors.nome && (
                    <p id="nome-error" className="mt-2 text-sm text-red-600 flex items-center">
              ...
              <div>
                <label htmlFor="assunto" className="block text-sm font-medium text-gray-700 mb-3">
                ...
                />
                {errors.assunto && (
                  <p id="assunto-error" className="mt-2 text-sm text-red-600 flex items-center">
                    <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                    </svg>
                    {errors.assunto}
              ...
              <div>
                <label htmlFor="mensagem" className="block text-sm font-medium text-gray-700 mb-3">
                ...
                <div className="flex justify-between items-center mt-2">
                  {errors.mensagem && (
                    <p id="mensagem-error" className="text-sm text-red-600 flex items-center">
                      <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                      </svg>
                      {errors.mensagem}
                  ...
                  <span className={`text-sm ml-auto ${
                    formData.mensagem.length > 800 ? 'text-red-500' : 'text-gray-500'
                  }`}>
              ...
              <button
                ...
                className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 disabled:cursor-not-allowed text-white font-medium py-4 px-6 rounded-lg transition-all duration-200 flex items-center justify-center space-x-2 transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
              >
                {isSubmitting ? (
                  <>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center mt-6">
            <div className="bg-blue-50 p-8 rounded-xl">
              ...
              <h3 className="font-semibold text-gray-900 mb-3 text-lg">E-mail</h3>
              <p className="text-gray-600">contato@riskmapping.com</p>
            </div>
            ...
            <div className="bg-green-50 p-8 rounded-xl">
              ...
              <h3 className="font-semibold text-gray-900 mb-3 text-lg">Tempo de Resposta</h3>
            ...
            <div className="bg-purple-50 p-8 rounded-xl">
              ...
              <h3 className="font-semibold text-gray-900 mb-3 text-lg">Localização</h3>
