...
const Layout = ({ children }) => {
  ...
  const TeamMember = ({ name, role, imageSrc, linkedinUrl, githubUrl }) => (
    <div className="text-center text-gray-500 dark:text-gray-400">
      ...
      <ul className="flex justify-center mt-4 space-x-4">
        <li>
          <a href={linkedinUrl} className="text-[#39569c] hover:text-gray-900 dark:hover:text-white" aria-label={`LinkedIn de ${name}`}>
        ...
        <li>
          <a href={githubUrl} className="text-gray-900 hover:text-gray-900 dark:hover:text-white dark:text-gray-300" aria-label={`GitHub de ${name}`}>
  ...
  <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
    ...
    <p className="font-light text-gray-500 sm:text-xl dark:text-gray-400">
      Nosso grupo está desenvolvendo um site focado em áreas de risco...
    </p>
  </div>
  ...
  const LiveMapSection = () => (
    <section className="bg-white dark:bg-gray-900 py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6 mb-8">
      <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
        <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
          Um mapa vivo feito por todos
        </h2>
        <p className="font-light text-gray-500 sm:text-xl dark:text-gray-400 text-justify">
        ...
        <section>
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white mt-8">
            Veja o vídeo
          </h2>
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Seção do mapa vivo (agora com o vídeo dentro) */}
      <LiveMapSection />
