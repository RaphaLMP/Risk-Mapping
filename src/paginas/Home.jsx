...
export default function Home() {
  ...
  return (
    <>
      <div className="w-full h-full flex flex-col items-center bg-gray-100 dark:bg-[#0e1e2e] transition-colors duration-500">
        {/* <div
        ...
        {/* <div className="w-[100%] md:w-[60%] -mt-72 relative z-10 backdrop-blur-md bg-white/10 dark:bg-[#0e1e2e]/70 rounded-2xl md:shadow-xl md:p-6 md:mb-12 transition-colors duration-500"> */}
        <div className="w-[90%] md:w-[60%] dark:bg-[#0e1e2e]/70 rounded-2xl md:shadow-xl md:p-6 md:mb-12 transition-colors duration-500">
          <MapComponent />
        </div>
        <ChatWidget />
